...
public class ShoppingCartTest {
    ...
    public Object[] parameterForTestGetTotalProductPrice(){
        Product p1 =  new Product(1l,"iphone 6","The worst iphone ever","20/12/36");
        Product p2 = new Product(2l, "Note II","The old","20/12/36");
        Product p3 = new Product (3l, "Chair", "Older chair","20/12/36" );
        return $(
